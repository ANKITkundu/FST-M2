package Activities;
	...
	public class Activity2 {
		...
		public void GetPostedPet() {
			...
			response.then().statusCode(200);
			response.then().body("firstName", equalTo("Guy"));
			response.then().body("lastName", equalTo("Tn"));
			response.then().body("email", equalTo("Guytn.gmail.com"));
			response.then().body("password", equalTo("guynt"));
